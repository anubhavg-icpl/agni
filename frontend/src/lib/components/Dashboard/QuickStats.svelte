...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4">
	{#each stats as stat, i}
		<div class="card hover:border-orange-500/30 transition-all duration-200 group">
			<div class="flex items-center gap-2 mb-2">
				<span class="text-lg group-hover:scale-110 transition-transform">{stat.icon}</span>
