...
<div class="space-y-6 lg:space-y-8">
	...
	<div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
		<div>
			<h1 class="text-2xl sm:text-3xl font-bold text-white mb-1">The VM Dungeon</h1>
			<p class="text-gray-400 text-sm sm:text-base">Where silicon souls go to suffer... I mean serve.</p>
		</div>
		<a
			href="/vms/new"
	...
	{#if $vms.loading && $vms.vms.length === 0}
		<div class="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-12">
			<div class="flex flex-col items-center justify-center text-center">
				...
				<p class="text-gray-400">Waking up the prisoners...</p>
			</div>
		</div>
	{:else if $vms.vms.length === 0}
		<div class="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-12">
			<div class="flex flex-col items-center justify-center text-center max-w-md mx-auto">
				...
				<h3 class="text-xl font-semibold text-white mb-2">The Dungeon is Empty</h3>
				<p class="text-gray-400 mb-6">No prisoners yet? How disappointingly peaceful. Fix that.</p>
				<a
					href="/vms/new"
				...
				>
					...
					<span>Summon Your First Victim</span>
				</a>
			</div>
		</div>
	{:else}
		<div>
			<div class="flex items-center justify-between mb-4">
				<h2 class="text-lg sm:text-xl font-semibold text-white">Your Prisoners</h2>
				<span class="text-sm text-gray-500">{$vms.vms.length} {$vms.vms.length === 1 ? 'soul' : 'souls'} trapped</span>
			</div>
	...
	{#if $vms.error}
		<div class="bg-gradient-to-r from-red-500/10 to-red-600/10 border border-red-500/30 rounded-2xl p-4 flex items-center gap-3">
			...
			<div>
				<p class="text-red-400 font-medium">The Dungeon Had a Meltdown</p>
